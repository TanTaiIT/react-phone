...
import { createOrderGhn,PrintOrderGhn } from "../../../../../redux/action/GhnAction";
import { deleteOrder,ShippingOrder,getAllOrder } from "../../../../../redux/action/OrderAction";
import { FormatMoney,formatDateOrderPaypal } from "../../../../../utils/untils";
        ...
        <div className="order-list-items">
          {orderItems.map((item) => (
            <div className="order-items-item">
              ...
              <span className="price">{FormatMoney(item.salePrice)}</span>
            </div>
          ))}
        </div>
        <div className="toatalPrice">
          <span>Tổng tiền: {FormatMoney(totalPrice)}</span>
        </div>
